...
const Terms = () => {
    const bonusDetails = [
        "Your first deposit of $100 or more gives 30% of bonus funds",
    ...
    return (
        <section className="rounded-t-[80px] bg-customGreyFour pt-[100px] pb-16 flex flex-col gap-24 relative">
            ...
            <BonusStructure
                ...
                footerNote="*The 30% Welcome Bonus will be credited to your account automatically after the deposit."
            />
        </section>
    );
};
