...
import Popup from "@/app/header/popup";
...
const Header = () => {
    ...
    const [activeMenuPopup, setActiveMenuPopup] = useState('');
    ...
    return (
        <>
            <header className="min-w-80 relative z-50 bg-white">
                <div
                    className="bg-customHeaderFont px-4 py-[9px] text-center text-[14px] leading-[16.8px] text-white max-sm:py-1 max-sm:text-[6px] max-sm:leading-[7.2px]">
                    <p>
            ...
            {" "}
                ...
                <div
                    className="mx-auto flex max-h-[83px] max-w-screen-xl flex-row items-center justify-between py-6 max-sm:max-h-[67px] max-sm:px-4 max-sm:py-4 max-sm:relative max-sm:z-50">
                    <div className="flex flex-row items-center gap-4">
                        ...
                        <div className="flex flex-row items-center gap-3 px-4 py-2 max-sm:hidden">
                    ...
                    {isSearchFind ? (
                        <div className="relative mx-8 w-3/5">
                            ...
                            {isSearchFind && inputValueTrading && (
                                <div
                                    className="box-shadow absolute left-0 top-[43px] z-10 flex w-full flex-col rounded-lg bg-white">
                    ...
                    {!isSearchFind && (
                        <div
                            className="flex h-[35px] w-[35px] cursor-pointer items-center justify-center rounded-[20px] bg-customBlue hover:bg-customBlueTwo max-sm:hidden"
                    ...
                    <div className="flex flex-row gap-2">
                        <Link href="/sign-up">
                            <button
                                type="button"
                                className="flex w-[88px] cursor-pointer items-center justify-center rounded-[44px] border-[1px] border-customGrey px-4 py-2 hover:bg-customGreyTwo active:bg-customGrey max-sm:w-[83px]"
                            >
              <span className="text-[14px] leading-[16.8px] text-customBlue">
                Sign up
                        ...
                        <Link href="https://customer.artsmrkts.com/login">
                            <button
                                type="button"
                                className="flex w-[88px] cursor-pointer flex-row items-center justify-center rounded-[44px] bg-customBlueFon px-4 py-2 hover:bg-customBlue active:bg-customBlueTwo max-sm:w-[66px] max-sm:px-0"
                            >
              <span className="text-[14px] leading-[16.8px] text-white">
                Sign in
                    ...
                    <Popup activeMenu={activeMenu} handleClickBurger={handleClickBurger} activeMenuPopup={activeMenuPopup} setActiveMenuPopup={setActiveMenuPopup}/>
                    <button id="burger" className="py-2 px-1.5 hidden max-sm:inline-block" type="button"
